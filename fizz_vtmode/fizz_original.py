...
parser.add_argument('--vt_mode', type=int, required=True,
                    help='0은 e,min 1은 e-c min, 2는 e mean, 3은 e-c mean 예: --vt_mode 0')
...
def main_original():
    ...
    for entry in tqdm(data, desc="Processing", mininterval=0.01):
        ...
        score = scorer.atomic_facts_scoring(doc, filtered_atomic_facts, args.vt_mode)
