...
parser.add_argument('--input_path', type=str, default='data/frank.json')
parser.add_argument('--output_path', type=str, default='results_align/fizz_rouge_sbert_frank.json')
