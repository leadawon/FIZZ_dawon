...
from decomposition_aggregate import DawonClass
...
def main_original():
    ...
    dawonclass = DawonClass(model_name=args.model_name)
    ...
    for entry in tqdm(data, desc="Processing", mininterval=0.01):
        ...
        atomic_facts = dawonclass.atomic_facts_decompose(summary)

        filtered_atomic_facts = filterer.atomic_facts_filtering(summary, atomic_facts)
        score = scorer.atomic_facts_scoring(doc, filtered_atomic_facts, dawonclass)
